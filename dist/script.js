...
window.addEventListener('load', function () {
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_4__["default"])('2021-12-18');
});
...
function calc() {
  var input = document.querySelectorAll('.popup_calc .form-control');
...
var modals = function modals() {
  function btndMadal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        console.log(e);
        showModal(modal); //document.body.classList.add('modal-open');
      });
    });
  ...
  function checked() {
    document.querySelectorAll('.checkbox').forEach(function (item, i) {
  ...
  var idTimeout = showModalByTime(document.querySelector('.popup'), 60000);
  checked();
};
...
var tabs = function tabs() {
  var ActivTab = document.querySelector('.decoration .decoration_slider .after_click');
  var ActivDecoration = document.querySelector('.decoration_content0');
  var decoration = document.querySelectorAll('.decoration .decoration_slider .no_click');
  var ActivGlazingTab = document.querySelector('.glazing .slick-current');
  var ActivGlazingContent = document.querySelector('.glazing_cont0');
  var glazing = document.querySelectorAll('.glazing .slick-active');

  function showTab(tabSelector, activeTab, activClass, typeTab) {
    document.querySelector(tabSelector).style.display = 'block';

    if (typeTab === 'decoration') {
      ActivTab = activeTab;
      ActivDecoration = document.querySelector(tabSelector);
    }

    if (typeTab === 'glazing') {
      ActivGlazingTab = activeTab;
      ActivGlazingContent = document.querySelector(tabSelector);
    }
  ...
  function clickTab() {
    decoration.forEach(function (elem, i) {
      elem.addEventListener('click', function (e) {
        var el = e.target;

        if (!el.classList.contains('no_click')) {
          el = el.parentElement;
        }

        hideTab(ActivDecoration, ActivTab, 'after_click', '');
        showTab(".decoration_content".concat(i), el, 'after_click', 'decoration');
      });
    });
    glazing.forEach(function (elem, i) {
      elem.addEventListener('click', function (e) {
        hideTab(ActivGlazingContent, ActivGlazingTab, '_', '');
        showTab(".glazing_cont".concat(i), e.target, '_', 'glazing');
      });
    });
    var windowsTab = document.querySelectorAll('.balcon_icons_img');
    windowsTab.forEach(function (elem, i) {
      elem.addEventListener('click', function (e) {
        var t = document.querySelector('.big_img.text-center img[style="display: block; margin: 0px auto;"]');
        ...
        showTab(".big_img.text-center [alt=\"\u0422\u0438\u043F".concat(i + 1, "\"]"), e.target.parentElement, 'do_image_more', '');
        document.querySelector(".big_img.text-center [alt=\"\u0422\u0438\u043F".concat(i + 1, "\"]")).style.margin = '0 auto';
      });
    });
  }
